...
## The original dataset: order-data-v4.csv
## Anonymized dataset: anonymized-order-data.csv
## 
## Note: The report was based on the original dataset. However, a sample anonymized dataset 
## is available.
## 
...
##
## •	CHEESE MONT JACK FCY SHRED
## •	CHICKEN THIGH IN MARINADE
## 
...
test <- apriori(finalOrderTX, 
                parameter = list(
                  ...
                  confidence = 0.9), 
                appearance = list(
                  lhs = c("CHEESE MONT JACK FCY SHRED", "CHICKEN THIGH IN MARINADE"),
                  default = "rhs"))
